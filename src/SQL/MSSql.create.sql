...
CREATE TABLE [ЗаписьВремя] (
	 ...
	 [ПрайсЛист] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [РасходМатериад] (
	 ...
	 [Трудозатраты] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [Услуга] (
	 ...
	 [ДатаУслуги] DATETIME  NULL,

	 [ЗаписьВремя] UNIQUEIDENTIFIER  NOT NULL,

	 [ПрайсЛист] UNIQUEIDENTIFIER  NOT NULL,

	 [ЗаписьКлиента] UNIQUEIDENTIFIER  NOT NULL,
