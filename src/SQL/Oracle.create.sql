...
ALTER TABLE "ЗаписьВремя"
	ADD CONSTRAINT "ЗаписьВремя_F_7133" FOREIGN KEY ("ПрайсЛист") REFERENCES "ПрайсЛист" ("primaryKey");

CREATE INDEX "ЗаписьВремя_I_1080" on "ЗаписьВремя" ("ПрайсЛист");

ALTER TABLE "РасходМатериад"
	ADD CONSTRAINT "РасходМатери_4498" FOREIGN KEY ("Материал") REFERENCES "Материал" ("primaryKey");

CREATE INDEX "РасходМатери_5330" on "РасходМатериад" ("Материал");

ALTER TABLE "РасходМатериад"
	ADD CONSTRAINT "РасходМатери_5273" FOREIGN KEY ("Трудозатраты") REFERENCES "Трудозатраты" ("primaryKey");

CREATE INDEX "РасходМатери_7743" on "РасходМатериад" ("Трудозатраты");
...
ALTER TABLE "Услуга"
	ADD CONSTRAINT "Услуга_FПрайс_4196" FOREIGN KEY ("ПрайсЛист") REFERENCES "ПрайсЛист" ("primaryKey");

CREATE INDEX "Услуга_IПрайс_5610" on "Услуга" ("ПрайсЛист");
